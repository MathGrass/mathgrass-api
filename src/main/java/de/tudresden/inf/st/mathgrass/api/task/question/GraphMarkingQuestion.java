...
public class GraphMarkingQuestion extends Question {
    ...
    @Override
    public boolean acceptQuestionVisitor(QuestionVisitor visitor, AnswerVisitor answerVisitor, String answer) {
        return visitor.visitGraphMarkingQuestion(this, answerVisitor, answer);
    }
}
